function(doc) {
	...
	//Map function for NEX (Number of Averages) (0018,0083)

	//If SOP class is Enhanced MR
	if (doc["0008,0016"] === "1.2.840.10008.5.1.4.1.1.4.1") {
	  tagpath = doc["5200,9229"]["Item 0"]["0018,9119"]["Item 0"]["0018,0083"]; // Number of averages
	}
	else {
	  //If SOP class is Regular MR or anything else (which will just not evaluate)
	  tagpath = doc["0018,0083"]; // Number of averages
	}
